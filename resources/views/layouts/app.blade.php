...
<div class="flex items-center gap-[10px] px-6 py-4
    ...
    <div class="w-[34px] h-[34px] rounded-full bg-[#E8EFFD]
...
{{-- 2. Heading besar di topbar --}}
@section('page-title', 'Project Saya')

{{-- 3. Sub-heading abu-abu (opsional) --}}
@section('page-sub', $projects->count().' project aktif')

{{-- 4. Tombol aksi di kanan topbar (opsional) --}}
