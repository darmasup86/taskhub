...
{{-- Langkah 3: Grid kartu project (muncul kalau ada data) --}}
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            @foreach($projects as $project)
                <a href="{{ route('projects.show', $project) }}"
                   class="bg-white rounded-2xl border border-[#ECECE9] p-5
                          ...
                          transition-all duration-200 block relative overflow-hidden group">
            ...
            <a href="{{ route('projects.create') }}"
               class="bg-white border-2 border-dashed border-[#ECECE9] rounded-2xl
                      flex flex-col items-center justify-center gap-3 min-h-[180px]
                      hover:border-[#FF6B4A] hover:text-[#FF6B4A] hover:bg-[#FFF7F5]
