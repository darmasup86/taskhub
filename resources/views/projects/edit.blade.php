...
<div class="max-w-2xl">
    <form action="{{ route('projects.update', $project) }}" method="POST"
        ...
        @csrf
        @method('PUT')  {{-- ← WAJIB: beritahu Laravel ini adalah PUT request --}}
        ...
        <div>
            ...
            <input type="text" name="name"
                   ...
                   class="w-full rounded-xl border border-[#ECECE9] bg-[#FAFAF8]
        ...
        <div>
            ...
            <div class="flex gap-2 flex-wrap">
                @foreach(['#3B82F6','#10B981','#F59E0B','#EF4444','#8B5CF6','#EC4899','#06B6D4','#F97316'] as $c)
